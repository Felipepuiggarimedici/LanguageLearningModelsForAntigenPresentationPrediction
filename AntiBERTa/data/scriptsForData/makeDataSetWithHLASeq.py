...
# Load peptide data
peptide_df = pd.read_csv("data/scriptsForData/fullDataSetIntermediate.csv")

# Load pseudo sequence data
pseudo_df = pd.read_csv("data/scriptsForData/pseudoSequence(ELIM).csv")
...
peptide_df.to_csv("data/scriptsForData/fullDataSetNew.csv", index=False)